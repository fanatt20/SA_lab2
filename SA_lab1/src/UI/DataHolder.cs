...
namespace UI
{
    internal class DataHolder : IDataHolder
    {
        ...
        public double[][] X1
        {
            get { return _x1 == null ? null : _x1.TakeBySecondCoordinate(MeterageCount > 0 ? MeterageCount : _x1[0].Length); }
            set
            {
                _x1 = value.DeepCopy();
        ...
        public double[][] X2
        {
            get { return _x2 == null ? null : _x2.TakeBySecondCoordinate(MeterageCount > 0 ? MeterageCount : _x2[0].Length); }
            set
            {
                _x2 = value.DeepCopy();
        ...
        public double[][] X3
        {
            get { return _x3 == null ? null : _x3.TakeBySecondCoordinate(MeterageCount > 0 ? MeterageCount : _x3[0].Length); }
            set
            {
                _x3 = value.DeepCopy();
        ...
        public double[][] Y
        {
            get { return _y == null ? null : _y.TakeBySecondCoordinate(MeterageCount > 0 ? MeterageCount : _y[0].Length); }
            set
            {
                _y = value.DeepCopy();
    ...
    internal class NormalizedDataHolder : IDataHolder
    {
        ...
        public double[][] AllVariables
        {
            get { return _variables == null ? null : _variables.TakeBySecondCoordinate(MeterageCount > 0 ? MeterageCount : _variables[0].Length); }
